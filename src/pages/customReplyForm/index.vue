...
<template>
  <section class="system-page-slot custom-reply-form app-page">
    ...
    <div class="custom-reply-form__content app-page__body app-page__body--has-sidebar">
      <app-page-sidebar
        ...
        :items="sidebarItems"
      />
      <div class="custom-reply-form__main app-page__main">
        <div class="custom-reply-form__main-header">
          <span class="material-symbols-rounded" aria-hidden="true"> folder </span>
          {{ currentCategory.category }}
        </div>
        <div class="custom-reply-form__results">
          <div
